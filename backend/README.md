...
## Project Structure
    ...
    ├── bitter_violet_dev_105913  # Django project configurations
...
1. Clone this repo and `cd bitter_violet_dev_105913`
...
2. Clone this repo and `cd bitter_violet_dev_105913`
