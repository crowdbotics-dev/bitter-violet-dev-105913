"""
Django settings for bitter_violet_dev_105913 project.
...
ROOT_URLCONF = 'bitter_violet_dev_105913.urls'
...
WSGI_APPLICATION = 'bitter_violet_dev_105913.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_violet_dev_105913 API",
    "DESCRIPTION": "API documentation for bitter_violet_dev_105913 App",
    "VERSION": "v1",
}
